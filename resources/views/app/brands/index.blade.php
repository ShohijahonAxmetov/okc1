...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">
            <!-- <a href="{{ route('brands.upload_from') }}" class="btn btn-sm btn-light-primary d-flex align-items-center" title="Download updates">
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-5">
                                    <img src="{{ isset($brand->img) ? asset($brand->img) : '/assets/media/stock/600x400/img-26.jpg' }}" class="" alt="">
                                </div>
