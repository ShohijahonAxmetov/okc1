...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">Адреса</span>
        </h3>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="d-flex justify-content-end">
                                <form action="{{ route('addresses.destroy', ['address' => $address]) }}" method="post">
                                    @csrf
                                    @method('delete')
                                ...
                                <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 ms-4" data-bs-toggle="modal" data-bs-target="#edit_banner{{ $address->id }}">
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<div class="modal fade" id="edit_banner{{ $address->id }}" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="{{ route('addresses.update', ['address' => $address]) }}" id="kt_modal_add_event_form" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <!--begin::Modal header-->
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder" data-kt-calendar="title">Изменения записи</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
                        ...
                        @if($loop->first)
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#kt_tab_pane_44a{{ $address->id }}">Русский</a>
                        </li>
                        @else
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_pane_55a{{ $address->id }}">O’zbek</a>
                        </li>
                        @endif
                        @endforeach
                    </ul>
                    ...
                    <div class="tab-content mb-9">
                        <div class="tab-pane fade show active" id="kt_tab_pane_44a{{ $address->id }}" role="tabpanel">
                        ...
                        <div class="tab-pane fade" id="kt_tab_pane_55a{{ $address->id }}" role="tabpanel">
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" placeholder="" name="address_uz" value="{{ $address->address['uz'] ?? '' }}" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
...
<div class="modal fade" id="add_post" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="{{ route('addresses.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <!--begin::Modal header-->
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Добавить адрес</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal">
                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
