				...
				<div class="aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<!-- PAGES -->
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::is('dashboard/pages/*') || Request::is('dashboard/pages') ? 'here show' : '' }}">
								<span class="menu-link">
									<span class="menu-icon">
										<!--begin::Svg Icon | path: icons/duotune/communication/com013.svg-->
										<span class="svg-icon svg-icon-2">
								...
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									@foreach($pages as $page)
									<div class="menu-item">
										<a class="menu-link {{ Request::is('dashboard/pages/'.$page->url.'/*') || Request::is('dashboard/pages/'.$page->url) ? 'active' : '' }}" href="{{ route($page->url) }}">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="menu-item">
								<a class="menu-link {{ Request::is('dashboard/reviews/*') || Request::is('dashboard/reviews') ? 'active' : '' }}" href="{{ route('reviews.index') }}">
									<span class="menu-icon">
										<span class="svg-icon ms-2 svg-icon-3 rotate-180">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
												<path opacity="0.3" d="M2 4V16C2 16.6 2.4 17 3 17H13L16.6 20.6C17.1 21.1 18 20.8 18 20V17H21C21.6 17 22 16.6 22 16V4C22 3.4 21.6 3 21 3H3C2.4 3 2 3.4 2 4Z" fill="currentColor" />
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::is('dashboard/infos/*') || Request::is('dashboard/infos') || Request::is('dashboard/addresses/*') || Request::is('dashboard/addresses') ? 'here show' : '' }}">
								<span class="menu-link">
									<span class="menu-icon">
										<!--begin::Svg Icon | path: icons/duotune/communication/com013.svg-->
										<span class="svg-icon svg-icon-2">
								...
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<div class="menu-item">
										<a class="menu-link {{ Request::is('dashboard/infos/*') || Request::is('dashboard/infos') ? 'active' : '' }}" href="{{ route('infos.index') }}">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title">Информация</span>
									...
									<div class="menu-item">
										<a class="menu-link {{ Request::is('dashboard/addresses/*') || Request::is('dashboard/addresses') ? 'active' : '' }}" href="{{ route('addresses.index') }}">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title">Адреса</span>
										</a>
									</div>
								</div>
							</div>

							<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::is('dashboard/integrations/*') || Request::is('dashboard/integrations') || Request::is('dashboard/integrations/*') || Request::is('dashboard/integrations') ? 'here show' : '' }}">
								<span class="menu-link">
									<span class="menu-icon">
										<!--begin::Svg Icon | path: icons/duotune/communication/com013.svg-->
										<span class="svg-icon svg-icon-2">
									...
									<span class="menu-title">Интеграции</span>
									<span class="menu-arrow"></span>
								</span>
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									<div class="menu-item">
