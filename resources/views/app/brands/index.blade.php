...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">
            ...
            <form action="{{ route('brands.index') }}" class="d-flex align-items-center">
                <div class="d-flex align-items-center position-relative my-1 ms-4">
                    ...
                    <input type="text" name="search" class="form-control form-control-solid w-250px ps-14" placeholder="Поиск бренда" value="{{ $search }}">
                </div>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-5">
                                    <img src="{{ isset($brand->img) ? asset($brand->img) : '/assets/media/default.png' }}" class="" alt="" style="object-fit:contain">
                                </div>
