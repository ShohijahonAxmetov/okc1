                            ...
                            <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end">
                                            <a href="../../demo1/dist/apps/user-management/users/view.html" class="text-gray-600 text-hover-primary">{{ isset($order->user) ? ($order->user->email ?? '--') : 'Deleted user' }}</a>
                                        </td>
                                    </tr>
                                    <!--end::Payment method-->
                                    <!--begin::Date-->
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end">+{{ isset($order->user) ? ($order->user->phone_number ?? '--') : 'Deleted user' }}</td>
                                    </tr>
                                    <!--end::Date-->
                                </tbody>
                                <!--end::Table body-->
