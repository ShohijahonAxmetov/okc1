                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="d-flex justify-content-end">
                                ...
                                <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 ms-4" data-bs-toggle="modal" data-bs-target="#edit_banner{{ $post->id }}">
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<div class="modal fade" id="edit_banner{{ $post->id }}" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="{{ route('posts.update', ['id' => $post->id]) }}" id="kt_modal_add_event_form" method="post" enctype="multipart/form-data">
                @csrf
                <!--begin::Modal header-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
                        ...
                        @if($loop->first)
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#kt_tab_pane_44a{{ $post->id }}">Русский</a>
                        </li>
                        @else
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_pane_55a{{ $post->id }}">O’zbek</a>
                        </li>
                        @endif
                        @endforeach
                    </ul>
                    ...
                    <div class="tab-content mb-9">
                        <div class="tab-pane fade show active" id="kt_tab_pane_44a{{ $post->id }}" role="tabpanel">
                        ...
                        <div class="tab-pane fade" id="kt_tab_pane_55a{{ $post->id }}" role="tabpanel">
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" placeholder="" name="title_uz" value="{{ $post->title['uz'] ?? '' }}" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
