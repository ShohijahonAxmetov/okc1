...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">Основные категории</span>
            ...
            <table class="table align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="fw-bolder text-muted bg-light">
                        ...
                        <th class="min-w-125px">Есть подкатегории</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="d-flex justify-content-start flex-column">
                                    ...
                                    <a href="
                                    @if($category['hasSubs'])
                                    {{$category['hasSubs'] ? route('integrations.express24.categories', ['id' => $category['id']]) : '#'}}
                                    @elseif(request('id'))
                                    {{route('integrations.express24.products', ['id' => $category['id']])}}
                                    @endif
                        ...
                        <td>
                            <a href="#" class="text-dark text-hover-primary d-block mb-1 fs-6">{{ $category['hasSubs'] ? 'Да' : 'Нет' }}</a>
                        </td>
                        <td>
                        ...
                        <td>
                            <a class="text-dark text-hover-primary d-block mb-1 fs-6">{{$category['sort']}}</a>
                        </td>
                        <td class="text-end">
...
<div class="modal fade" id="edit_category{{ $category['id'] }}" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="{{ route('integrations.express24.categories.update') }}" id="kt_modal_add_event_form" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{$category['id']}}">
                <!--begin::Modal header-->
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder" data-kt-calendar="title">Изменение категории "{{ $category['name'] }}"</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="fv-row mb-6">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="" name="name" value="{{ $category['name'] ?? '' }}" />
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="fv-row mb-6">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="" name="sort" value="{{ $category['sort'] ?? '' }}" />
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="fv-row mb-9">
                        ...
                        <select class="form-select" aria-label="" name="is_active" data-control="select2" data-hide-search="true">
                            <option value="1" {{ $category['isActive'] == 1 ? 'selected' : '' }}>Активный</option>
                            <option value="0" {{ $category['isActive'] == 0 ? 'selected' : '' }}>Неактивный</option>
                        </select>
                    </div>
                </div>
                <!--end::Modal body-->
