						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::is('dashboard/brands/*') || Request::is('dashboard/brands') || Request::is('dashboard/categories/*') || Request::is('dashboard/categories') || Request::is('dashboard/products/*') || Request::is('dashboard/products') || Request::is('dashboard/attributes/*') || Request::is('dashboard/attributes') ? 'here show' : '' }}">
								...
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									...
									<!-- <div class="menu-item">
										<a class="menu-link {{ Request::is('dashboard/attributes/*') || Request::is('dashboard/attributes') ? 'active' : '' }}" href="../../demo1/dist/account/billing.html">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<!-- <div class="menu-item">
								<a class="menu-link {{ Request::is('dashboard/filters/*') || Request::is('dashboard/filters') ? 'active' : '' }}" href="../../demo1/dist/apps/calendar.html">
									<span class="menu-icon">
										<span class="svg-icon ms-2 svg-icon-3 rotate-180">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
							...
							<div class="menu-item">
								<a class="menu-link {{ Request::is('dashboard/mailing/*') || Request::is('dashboard/mailing') ? 'active' : '' }}" href="../../demo1/dist/apps/calendar.html">
									<span class="menu-icon">
										<!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
										<span class="svg-icon ms-2 svg-icon-3 rotate-180">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
