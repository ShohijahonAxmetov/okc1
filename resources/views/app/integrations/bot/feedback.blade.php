...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">Обратная связь от пользователей</span>
            ...
            <table class="table align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="fw-bolder text-muted bg-light">
                        ...
                        <th class="min-w-200">Номер телефона при регистрации</th>
                        <th class="min-w-200">Сообщение</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="ps-3 fw-bold">
                            <p>#{{ $loop->iteration + $feedbacks->firstItem() - 1 }}</p>
                        </td>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex justify-content-start flex-column ms-2">
                                    <a href="#" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{ $feedback->telegram_id }}</a>
                                </div>
                            </div>
                        </td>
                        <td>
                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $feedback->telegramUser->first_name }}</a>
                        </td>
                        <td>
                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $feedback->telegramUser->username }}</a>
                        </td>
                        <td>
                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $feedback->phone_number ?? '-' }}</a>
                        </td>
                        <td>
                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $feedback->telegramUser->user->phone_number ?? '-' }}</a>
                        </td>
                        <td>
                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $feedback->message }}</a>
                        </td>
                        <!-- <td class="text-end"> -->
